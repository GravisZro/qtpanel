  ...
  : X11Core(argc, argv)
{
  ...
  for(int i = 0; i < num_panels; ++i)
  {
    ...
    plugin_names.append("plugins/libapplicationsmenuplugin.so");
    plugin_names.append("plugins/libdockplugin.so");
    plugin_names.append("plugins/libtrayplugin.so");
    plugin_names.append("plugins/libclockplugin.so");
